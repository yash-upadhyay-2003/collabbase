...
export default function StatusBadge() {
    ...
    return (_jsxs("span", { style: { ...styles.badge, color, backgroundColor: bg }, children: [_jsx("span", { style: { ...styles.dot, backgroundColor: dot, boxShadow: status === "ok" ? `0 0 6px ${dot}` : "none" } }), label] }));
}
const styles = {
    badge: {
        display: "inline-flex",
